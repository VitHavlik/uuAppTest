const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci newApp",
      en: "About application newApp",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní newApp.",
      en: "You can buy your own newApp.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci newApp.",
      en: "You don't have rights to initialize this newApp.",
    },
  },
